...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistration":       schema_auditor_apis_auditor_v1alpha1_AuditRegistration(ref),
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationList":   schema_auditor_apis_auditor_v1alpha1_AuditRegistrationList(ref),
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationSpec":   schema_auditor_apis_auditor_v1alpha1_AuditRegistrationSpec(ref),
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationStatus": schema_auditor_apis_auditor_v1alpha1_AuditRegistrationStatus(ref),
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.GroupResources":          schema_auditor_apis_auditor_v1alpha1_GroupResources(ref),
		"kmodules.xyz/auditor/apis/auditor/v1alpha1.PolicyRule":              schema_auditor_apis_auditor_v1alpha1_PolicyRule(ref),
	}
}
...
func schema_auditor_apis_auditor_v1alpha1_AuditRegistration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationSpec", "kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistrationStatus"},
	}
}
...
func schema_auditor_apis_auditor_v1alpha1_AuditRegistrationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistration"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kmodules.xyz/auditor/apis/auditor/v1alpha1.AuditRegistration"},
	}
}
...
func schema_auditor_apis_auditor_v1alpha1_AuditRegistrationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"rules": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kmodules.xyz/auditor/apis/auditor/v1alpha1.PolicyRule"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"kmodules.xyz/auditor/apis/auditor/v1alpha1.PolicyRule"},
	}
}
...
func schema_auditor_apis_auditor_v1alpha1_PolicyRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"resources": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kmodules.xyz/auditor/apis/auditor/v1alpha1.GroupResources"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"kmodules.xyz/auditor/apis/auditor/v1alpha1.GroupResources"},
	}
}
